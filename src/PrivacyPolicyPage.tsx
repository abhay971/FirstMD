 ...
 * (node 397:2827). Layout/chrome come from the shared LegalDocPage scaffold;
 * this file only supplies the title, subtitle, and body content.
 */
...
export default function PrivacyPolicyPage() {
  return <LegalDocPage title="Privacy Policy" subtitle={SUBTITLE} blocks={BLOCKS} />
}
